...
var Business_Listings = function (_Component) {
  ...
  function Business_Listings() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Business_Listings.__proto__ || Object.getPrototypeOf(Business_Listings)).call.apply(_ref, [this].concat(args))), _this), _this.empty = function () {}, _temp), _possibleConstructorReturn(_this, _ret);
  }
